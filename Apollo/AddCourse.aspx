<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="AddCourse.aspx.cs" Inherits="Apollo.AddCourse" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <asp:DropDownList ID="CourseTypelist" CssClass="form-control" runat="server" OnSelectedIndexChanged="CourseTypelist_SelectedIndexChanged">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <asp:DropDownList ID="prgramlist" CssClass="form-control" runat="server" OnSelectedIndexChanged="prgramlist_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <asp:Button CssClass="btn btn-primary" ID="saveButton" Text="Save Course" runat="server" OnClick="saveButton_Click" />
                                        </div>
                                    </div>
                                </div>
                            </div>
